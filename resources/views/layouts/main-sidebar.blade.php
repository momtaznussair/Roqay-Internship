		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					@can('Category_access')
					<li class="side-item side-item-category">{{__('Categories')}}</li>
					<li class="slide">
					...
					@can('Product_access')
					<li class="side-item side-item-category">{{__('Products')}}</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('products') }}">
							<i class="fas fa-layer-group mx-1" style="color: gray; font-size:1.3rem;"></i>
							<span class="side-menu__label" style="color: gray;">{{__('Products')}}</span>
							<i class="angle fe fe-chevron-down"></i>
						</a>
					</li>
					@endcan
