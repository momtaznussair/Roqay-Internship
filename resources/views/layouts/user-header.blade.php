            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    @if (Auth('web')->user()->avatar)
                        <a class="profile-user d-flex" href=""><img alt="" src="{{asset('storage/' . Auth('web')->user()->avatar)}}""></a>
                    @else
                        ...
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                ...
                                <div class="mr-3 my-auto">
                                    <h6 class="ml-2">{{Auth('web')->user()->name}}</h6>
                                </div>
                            </div>
                        </div>
...
<nav class="nav nav-pills flex-column bg-light font-weight-bold flex-md-row">
